...
private fun CrashScreen(
    ...
    val copiedLabel = "Copied to clipboard"
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "HayaiTTS crashed",
                style = MaterialTheme.typography.headlineSmall,
            )
            Text(
                text = "Sorry — something went wrong. Copy the report below and " +
                    "paste it into a GitHub issue at " +
                    "github.com/HayaiApp/HayaiTTS so we can fix it.",
